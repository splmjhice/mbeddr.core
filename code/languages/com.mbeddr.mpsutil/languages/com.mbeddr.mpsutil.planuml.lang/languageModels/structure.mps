...
<model modelUID="r:fa2203ef-3a22-41de-a7d2-fe30d5256021(com.mbeddr.mpsutil.planuml.lang.structure)" version="5">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5049397430599272381" nodeInfo="ig">
    ...
    <property name="virtualPackage" nameId="tpck.1193676396447" value="sequence.participant" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5923081993706050501" nodeInfo="ig">
    ...
    <property name="virtualPackage" nameId="tpck.1193676396447" value="sequence.transition.arrows" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5923081993706050535" nodeInfo="ig">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="5923081993706246285" nodeInfo="ig">
      ...
      <link role="target" roleId="tpce.1071599976176" targetNodeId="5923081993706246081" resolveInfo="DiagramEntityRef" />
    </node>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5923081993706246081" nodeInfo="ig">
    <property name="name" nameId="tpck.1169194664001" value="DiagramEntityRef" />
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="5923081993706246082" nodeInfo="ig">
      ...
      <property name="role" nameId="tpce.1071599776563" value="target" />
      <property name="sourceCardinality" nameId="tpce.1071599893252" value="1" />
      <link role="target" roleId="tpce.1071599976176" targetNodeId="5923081993706815360" resolveInfo="DiagramEntity" />
    </node>
  </root>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5923081993706252963" nodeInfo="ig">
    ...
    <property name="conceptAlias" nameId="tpce.5092175715804935370" value="/-" />
    <property name="virtualPackage" nameId="tpck.1193676396447" value="sequence.transition.toparrows" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="5923081993706050535" resolveInfo="Transition" />
  </root>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5923081993706260520" nodeInfo="ig">
    ...
    <property name="conceptAlias" nameId="tpce.5092175715804935370" value="\-" />
    <property name="virtualPackage" nameId="tpck.1193676396447" value="sequence.transition.buttomarrows" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="5923081993706050535" resolveInfo="Transition" />
  </root>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5923081993706815360" nodeInfo="ig">
    <property name="abstract" nameId="tpce.4628067390765956802" value="true" />
    <property name="name" nameId="tpck.1169194664001" value="DiagramEntity" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="5049397430599272434" resolveInfo="PlantUMLBaseConcept" />
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="5923081993706815361" nodeInfo="ig">
